...
def place_homes(room):
    ...
    npc = random.choice(['lumberjack','leathersmith','nurse','farmer','farmer','farmer','farmer'])
    ...
    if game_state == 'playing':
        ...
        if key.vk == libtcod.KEY_UP or key.vk == libtcod.KEY_KP8 or chr(key.c) == 'w':
            ...
            if key_char in ['q','Q'] or key.vk == libtcod.KEY_KP1:
            	...
            	if weap_2 is not None and weap_2.owner.name.split(' ')[1] not in ['spear','bow','boomerang','stick']:
            		if weap_2.owner.name.split(' ')[1] in ['spear','bow','boomerang','stick']:
            			curr_weap = weap_2
